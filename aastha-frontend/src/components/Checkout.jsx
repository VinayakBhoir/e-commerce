            ...
            <div className="container pb-5">
                ...
                <div className="row">
                    <div className="col-md-7">
                        <h3 className='border-bottom'><strong>Billing Details</strong></h3>
                        <form action="">
                            <div className='row pt-3'>
                                ...
                                <div className='mb-3'>
                                    <textarea rows={3} className='form-control' placeholder='Address' ></textarea>
                                </div>
                                <div className='col-md-6'>
                                    <div className='mb-3'>
                    ...
                    <div className="col-md-5">
                        <h3 className='border-bottom'><strong>Items</strong></h3>
                        <table className='table border-bottom'>
                            <tbody>
                                <tr>
                                    <td width={100}>
                                        <img src={ProductImg} width={120} alt='' />
                                    </td>
                                    <td width={600}>
                                        <h4>Dommy product title</h4>
